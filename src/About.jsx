...
import food_Image from "../Images/foods.jpg";
...
const About = () => {
  ...
  return (
    <>
      {/* Hero Section */}
      <div className="relative bg-[url('/Images/foods.jpg')] bg-cover bg-center min-h-[220px] md:min-h-[280px] lg:min-h-[340px] flex items-center justify-center text-white px-4">
        ...
        <motion.h1
          ...
          className="relative z-10 text-4xl sm:text-5xl md:text-6xl font-bold text-center poppins-bold"
        >
          About Us
        </motion.h1>
      </div>
      ...
      <motion.div
        ...
        variants={fadeInUp}
        transition={{ duration: 0.8 }}
        className="w-full bg-yellow-50 py-12 px-4 flex justify-center"
      >
          ...
          <div className="space-y-8">
            <div className="timeline-item">
              <div className="flex justify-center items-center gap-6">
                <div className="w-10 h-10 bg-yellow-500 text-white rounded-full flex items-center justify-center text-xl font-bold">
                  2022
                </div>
